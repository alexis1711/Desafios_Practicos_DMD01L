DROP DATABASE db_roaming_honduras
...
SELECT cli.idcliente, cli.idtipocliente, cli.dui, cli.nit, cli.codigo_cliente, cli.nombres, cli.apellidos, cli.numero_telefono, cli.sexo, cli.estado, fact.monto_facturacion, tipo.nombre_tipo FROM cliente cli INNER JOIN facturacion fact ON cli.idcliente = fact.idcliente
